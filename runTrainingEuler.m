...
% an sNODE network by NCG-method, using Euler's scheme to solve ODEs
%
% It sets up parameters as needed and calls ncgTrainingEuler
%
...
ncgMethod = 'FR';   % method for determining conjugate gradient coefficient (see help of ncgGamma)
batchSize = 100;    % number of images in each minibatch
measFrequency = 20; % how often accuracy is measured (every 20th batch)

outputFileNm = 'ncg_euler1.mat';  % file where the trained weights and biases will be saved
...
ncgTrainingEuler(verbose, trainInputData, trainClass, testInputData, testClass, ...
                 inputBgEnc, inputFgEnc, l2enc0, l2enc1, ...
                 actFun, mu1, mu2, mu3, mu4, ...
                 noEpochs, noIterations, batchSize, ...
                 tResolution, T, bSobolev, ncgMethod, ...
